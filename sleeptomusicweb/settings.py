# Django settings for sleeptomusicweb project.
...
DATABASES = {
    'default': {
        ...
        'NAME': '/tmp/sleeptomusic.db',                      # Or path to database file if using sqlite3.
...
#SECRET_KEY = 'h=kc&amp;jh=o05n(b6w9_cai%)5ym%*c^bq^@ngycd41gzn=7u@1w'
...
ROOT_URLCONF = 'sleeptomusicweb.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sleeptomusicweb.wsgi.application'
...
# Settings for 3rd party services, like passwords etc.

if DEBUG:
    import os
    site_settings_file = os.path.expanduser('~') + "/.sleeptomusic"
else:
    site_settings_file = "/etc/sleeptomusic"
    
config_parser = ConfigParser.ConfigParser()
config_parser.read(site_settings_file)
